...
<object class="GenericRobot2" serializationversion="2">
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="2">amazonTenderedChargeReport</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
    ...
    <steps class="ArrayList">
        ...
        <steps class="ArrayList">
            ...
            <property name="stepAction" class="AssignVariable" serializationversion="4">
              <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
                <property name="dataConverters" class="DataConverters">
                  <element class="GetVariable" serializationversion="2">
                    <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                      <property name="name" class="String" id="20">DATE1</property>
                    </property>
                  </element>
                  <element class="EvaluateExpression" serializationversion="0">
          ...
          <object class="Transition" serializationversion="3" id="30">
            ...
            <property name="stepAction" class="QueryDatabase2" serializationversion="1">
              ...
              <property name="sql" class="String">"SELECT Julian_Day,GregorianMonth,GregorianDay FROM " + JULIAN_TABLE + " where GregorianMonth = '" + MONTH + "' and GregorianDay = '" + DAY + "'"</property>
              <property name="columnAttributeMappings" class="kapow.robot.plugin.common.support.database.ColumnAttributeMappings">
                <object class="kapow.robot.plugin.common.support.database.ColumnAttributeMapping">
                  <property name="columnName" class="String">Julian_Day</property>
          ...
          <object class="Transition" serializationversion="3" id="31">
            ...
            <property name="stepAction" class="AssignVariable" serializationversion="4">
              <property name="stringExpr" class="Expression" serializationversion="1">
                <property name="text" class="String">YEAR + DATE1</property>
              </property>
              <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                <property name="name" idref="20"/>
              </property>
      ...
      <object class="Transition" serializationversion="3" id="47">
        ...
        <property name="stepAction" class="QueryDatabase2" serializationversion="1">
          ...
          <property name="sql" class="String">"SELECT DISTINCT DATE(DIGITS(ORDER.ORDATE)) AS ACCDATE,ORDER.ORODR#,ORDER.ORCSH#,ORDER.ORBILL,ORDER.ORLDAT,ORDER.ORCONS,S1.SOCTYC AS S1CITY,S1.SOST AS S1STATE,S2.SOCTYC AS S2CITY,S2.SOST AS S2STATE,STOPOFFR.SRRREF,ORDER.ORSPEC FROM ORDER 

LEFT JOIN STOPOFFR ON ORDER.ORODR# = STOPOFFR.SRORD
LEFT JOIN STOPOFF S1 ON ORODR# = S1.SOORD AND ORDER.ORLDAT = S1.SOCUST
LEFT JOIN STOPOFF S2 ON ORDER.ORODR# = S2.SOORD AND ORDER.ORCONS = S2.SOCUST

WHERE S1.SOSTP# = '1' AND ORDER.ORBILL IN ('AMAZN','AMAZO1','AMAZO2','AMAZO3','AMAZO4','AMAZO5','AMAZO6','AMAZO7','AMAZO8','AMAZ10','AMAZ12','AMAZ14','AMAZ15','AMAZ16','AMAZ17') AND (ORDER.ORDATE = '" + DATE1 + "' OR ORDER.ORDATE = '" + DATE2 + "' OR ORDER.ORDATE = '" + DATE3 + "' OR ORDER.ORDATE = '" + DATE4 + "' OR ORDER.ORDATE = '" + DATE5 + "' OR ORDER.ORDATE = '" + DATE6 + "' OR ORDER.ORDATE = '" + DATE7 + "') AND ORDER.ORSTAT != 'C' AND STOPOFFR.SRNTYP = 'TC'
      ...
      <object class="Transition" serializationversion="3" id="51">
        ...
        <property name="stepAction" class="SendEmail">
          ...
          <property name="subject" class="Expression" serializationversion="1">
            <property name="text" class="String">&gt;&gt;Amazon Tendered Charge Report. Week of &lt;&lt; + date</property>
          </property>
          ...
          <property name="attachmentFileName" class="Expression" serializationversion="1">
            <property name="text" class="String">date + &gt;&gt;_Amazon_Tendered_Charge_Report.xlsx&lt;&lt;</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
